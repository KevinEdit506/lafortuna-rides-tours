...
The fare model follows the familiar distance-based structure used by ride-hailing services: a base amount, a distance component, a time component, operating costs, and a platform/coverage component, followed by the active 10% promotion. Private fares are calculated once per trip; shared fares calculate each passenger route independently.
