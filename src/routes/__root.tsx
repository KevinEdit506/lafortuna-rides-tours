...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Traslados privados y tours bilingües en La Fortuna, Costa Rica." },
      { name: "author", content: "Via La Fortuna" },
      { property: "og:title", content: "Via La Fortuna" },
      { property: "og:description", content: "Traslados privados y tours bilingües en La Fortuna, Costa Rica." },
